...
CREATE INDEX idx_patient_records_email_lookup ON public.patient_records(email);
CREATE INDEX idx_patient_records_member_id ON public.patient_records(member_id);

ALTER TABLE public.patient_records ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Allow select for anon on patient_records" ON public.patient_records FOR SELECT TO anon USING (true);
CREATE POLICY "Allow insert for anon on patient_records" ON public.patient_records FOR INSERT TO anon WITH CHECK (true);
CREATE POLICY "Allow all for authenticated on patient_records" ON public.patient_records FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow select for anon on bookings" ON public.bookings FOR SELECT TO anon USING (true);
CREATE POLICY "Allow insert for anon on bookings" ON public.bookings FOR INSERT TO anon WITH CHECK (true);
CREATE POLICY "Allow all for authenticated on bookings" ON public.bookings FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
-- Update patient_records FK now that bookings exists
...
CREATE POLICY "Allow select for anon on transactions" ON public.transactions FOR SELECT TO anon USING (true);
CREATE POLICY "Allow all for authenticated on transactions" ON public.transactions FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow select for anon on benefits" ON public.membership_benefits FOR SELECT TO anon USING (true);
CREATE POLICY "Allow all for authenticated on benefits" ON public.membership_benefits FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow select for anon on claims" ON public.member_benefit_claims FOR SELECT TO anon USING (true);
CREATE POLICY "Allow insert for anon on claims" ON public.member_benefit_claims FOR INSERT TO anon WITH CHECK (true);
CREATE POLICY "Allow all for authenticated on claims" ON public.member_benefit_claims FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow select for anon on rewards" ON public.referral_rewards FOR SELECT TO anon USING (true);
CREATE POLICY "Allow insert for anon on rewards" ON public.referral_rewards FOR INSERT TO anon WITH CHECK (true);
CREATE POLICY "Allow all for authenticated on rewards" ON public.referral_rewards FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow select for anon on admin_settings" ON public.admin_settings FOR SELECT TO anon USING (true);
CREATE POLICY "Allow all for authenticated on admin_settings" ON public.admin_settings FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
-- ===========================================================================
-- FUNCTION: Generate Referral Code (first 6 letters of name)
-- ===========================================================================

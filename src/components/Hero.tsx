...
const Hero = () => {
  return (
    <section className="relative min-h-[60vh] md:min-h-[80vh] flex items-center overflow-hidden pt-8 md:pt-0">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="max-w-xl">
          ...
          >
            <Button
              size="default"
              className="gradient-accent text-accent-foreground hover:opacity-90 transition-all duration-300 hover:scale-105 px-4 md:px-6 py-2 md:py-3 text-sm md:text-base rounded-full"
            >
              Book Now
            </Button>
            <Button
              size="default"
              variant="outline"
              className="border-foreground/30 text-foreground hover:bg-foreground/5 px-4 md:px-6 py-2 md:py-3 text-sm md:text-base rounded-full"
            >
              Shop Now
            </Button>
          </motion.div>
